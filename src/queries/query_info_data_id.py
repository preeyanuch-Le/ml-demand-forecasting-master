...
LEFT JOIN
(
select distinct dp.id_product,pv.warehouse,pv.week_id, dp.date_released_id,
case when pv.week_id = 'week1' then dp.date_released_id
          when pv.week_id = 'week2' then DATE_ADD('day', 7, dp.date_released_id)
          when pv.week_id = 'week3' then DATE_ADD('day', 14, dp.date_released_id)
          when pv.week_id = 'week4' then DATE_ADD('day', 21, dp.date_released_id)
          when pv.week_id = 'week5' then DATE_ADD('day', 28, dp.date_released_id)
          when pv.week_id = 'week6' then DATE_ADD('day', 35, dp.date_released_id)
          when pv.week_id = 'week7' then DATE_ADD('day', 42, dp.date_released_id)
          when pv.week_id = 'week8' then DATE_ADD('day', 49, dp.date_released_id)
          when pv.week_id = 'week9' then DATE_ADD('day', 56, dp.date_released_id)
          when pv.week_id = 'week10' then DATE_ADD('day', 63, dp.date_released_id)
          when pv.week_id = 'week11' then DATE_ADD('day', 70, dp.date_released_id)
          when pv.week_id = 'week12' then DATE_ADD('day', 77, dp.date_released_id)
          when pv.week_id = 'week13' then DATE_ADD('day', 84, dp.date_released_id)
          when pv.week_id = 'week14' then DATE_ADD('day', 91, dp.date_released_id)
          when pv.week_id = 'week15' then DATE_ADD('day', 98, dp.date_released_id)
          when pv.week_id = 'week16' then DATE_ADD('day', 105, dp.date_released_id)
          when pv.week_id = 'week17' then DATE_ADD('day', 112, dp.date_released_id)
...
ORDER BY 1,2,3
        ...
        """
    info_data_id = wr.athena.read_sql_query(sql, database="dwh_snapshot")
    return info_data_id
